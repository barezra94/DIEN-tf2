...
with open(args.dataset_dir+'dataset_with_time.pkl', 'rb') as f:
...
# with open(arg.dataset_dir+'dataset_with_time.pkl', 'rb') as f:
#     train_set = pickle.load(f, encoding='latin1')
#     test_set = pickle.load(f, encoding='latin1')
#     cate_list = pickle.load(f, encoding='latin1')
#     cate_list = tf.convert_to_tensor(cate_list, dtype=tf.int64)
...
class DataLoader_wt:
    ...
    def __next__(self):
        ...
        return tf.convert_to_tensor(u), tf.convert_to_tensor(i), \
               tf.convert_to_tensor(y), tf.convert_to_tensor(hist_i), \
               sl , tf.convert_to_tensor(urt)

class DataLoaderTest_wt:
    def __init__(self, batch_size, data):
...
def get_dataloader_wt(train_batch_size, test_batch_size):
    return DataLoader_wt(train_batch_size, train_set), DataLoaderTest_wt(test_batch_size, test_set), \
           user_count, item_count, cate_count, cate_list
